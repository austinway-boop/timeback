        ...
        try {
            ...
            if (allTests.length) {
                ...
                document.getElementById('tests-grid').innerHTML = allTests.map(t => {
                    ...
                    // Direct test link on MasteryTrack
                    const testUrl = t.assignmentId
                        ? 'https://alphatest.alpha.school/test/' + encodeURIComponent(t.assignmentId)
                        : 'https://alphatest.alpha.school';
